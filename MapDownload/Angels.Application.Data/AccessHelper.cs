...
namespace Angels.Application.Data
{
    ...
    {
        //数据库连接字符串
        public static readonly string conn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + System.AppDomain.CurrentDomain.BaseDirectory + "\\App_Data\\log.mdb";
        //public static readonly string conn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + System.AppDomain.CurrentDomain.BaseDirectory + @"../../" + "App_Data\\log.mdb";
        //"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + HttpContext.Current.Server.MapPath("/App_Data/log.mdb");
